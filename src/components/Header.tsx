      ...
      <div className="mx-auto max-w-7xl">
        <div className="relative">
          ...
          <div className="relative overflow-hidden rounded-2xl panel px-6 py-4">
            <div className="pointer-events-none absolute inset-0 opacity-60 mix-blend-screen bg-gradient-to-r from-forge-primary/25 via-transparent to-forge-secondary/25 blur-3xl" />
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                <div className="absolute inset-0 rounded-xl bg-forge-primary/30 blur-2xl opacity-60" />
              ...
              <div className="flex flex-col">
                <span className="text-[0.65rem] uppercase tracking-[0.42em] text-forge-gray-400 font-heading">
                  Forge Protocol
                </span>
                ...
                {NAV_ITEMS.map(({ label, href, active }) => (
                  <a
                    ...
                    className={`relative inline-flex items-center justify-center rounded-xl px-5 py-2 transition-all duration-300 uppercase tracking-[0.2em] text-[0.7rem] font-heading border ${
                      active
                        ? 'bg-gradient-to-r from-forge-primary to-forge-primary-light text-white shadow-[0_10px_30px_rgba(255,106,0,0.35)] border-white/20'
                        : 'text-forge-gray-300/90 border-white/10 hover:text-white hover:bg-white/10 hover:border-white/20'
                    }`}
                  >
                    {label}
                    {active && (
